...
def main():
    ...
    if os.path.isfile("./" + model_name):
        ...
        trainer.train_and_save(
            FashionMNISTLoader.train_dataloader,
            FashionMNISTLoader.test_dataloader,
            learning_rate=1e-3,
            batch_size=64,
            epochs=5,
            model_name="model.pth",
    ...
    model_architecture = NeuralNetworkProfiler.get_model_architecture_dict_of_input(
        random_inputs[0], model_layers_arr
    )
