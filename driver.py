...
class Driver:
    ...
    def get_coverage_of_layers(self, input_idx):
        ...
        for layer_index in range(len(activation_info)):
            ...
            result.append((layer_index, activation_fn, num_of_covered_neurons, total_neurons, coverage))
    ...
    def get_th_coverage_of_layer(self, input_idx, layer_index, threshold_value):
        ...
        (
            ...
            total_neurons,
            coverage,
        ) = Coverage.get_threshold_coverage_for_single_layer(layer_after_values, threshold_value)
    ...
    def get_th_coverage_of_layers(self, input_idx, threshold_value):
        ...
        for layer_index in range(len(activation_info)):
            ...
            (
                ...
                total_neurons,
                coverage,
            ) = Coverage.get_threshold_coverage_for_single_layer(layer_after_values)
            result.append((layer_index, activation_fn, num_of_covered_neurons, total_neurons, coverage))
    ...
    def get_th_coverage_of_model(self, input_idx, threshold_value):
        ...
        (
            ...
            total_neurons,
            coverage,
        ) = Coverage.get_threshold_coverage_for_all_layers(layer_after_values, threshold_value)
